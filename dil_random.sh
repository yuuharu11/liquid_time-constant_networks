...
task_0_OUTPUT_DIR="/work/outputs/ncps/DIL/random/baseline/train_task_0"
...
python3 train.py \
    ...
    callbacks.experiment_logger.output_file="/work/test/DIL/random_baseline.csv"
...
for i in {1..9}; do
  ...
  prev_task_num=$((i - 1))
  last_checkpoint="/work/outputs/ncps/DIL/random/baseline/train_task_${prev_task_num}/checkpoints/last.ckpt"
  OUTPUT_DIR="/work/outputs/ncps/DIL/random/baseline/train_task_${i}"
