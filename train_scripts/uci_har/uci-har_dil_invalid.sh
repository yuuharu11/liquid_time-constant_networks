...
# --- DILタスクのシーケンス定義 ---
TASKS=(
  "0,-1.0"      # Task 1: total_acc 故障 (軽微)
  "1,-1.0"      # Task 2: body_acc 故障 (軽微)
  "2,-1.0"      # Task 3: body_gyro 故障 (軽微)
  "3,-1.0"      # Task 4: 複合故障 (body_acc + gyro)
  "4,-1.0"      # Task 5: 複合故障 (body_gyro + total_acc)
  "5,-1.0"      # Task 6: 複合故障 (body_acc + total_acc)
...
for MODEL in "${MODELS[@]}"; do
  ...
  MODEL=${MODEL,,}  # 小文字化
  RESULTS_DIR="/work/outputs/${MODEL}/uci_har_standard/dil_ex"
  CSV_LOG_PATH="/work/csv/uci-har/dil_ex/${MODEL}.csv"
  GROUP_NAME="${MODEL^^}_EX"
